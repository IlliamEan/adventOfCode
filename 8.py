...
esc_inn = [escaped_string(string) for string in inn]
len_inn = sum([len(string) + 2 for string in inn])
len_esc_inn = sum([len(string) for string in esc_inn])
print len_inn - len_esc_inn
